...
namespace assessment2_cs {
    ...
    public partial class DBDataSet : global::System.Data.DataSet {
        ...
        public partial class guestDataTable : global::System.Data.TypedTableBase<guestRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public guestRow AddguestRow(int id, bookingRow parentbookingRowByFK_guest_booking, string passport_num, int age) {
                ...
                if ((parentbookingRowByFK_guest_booking != null)) {
                    columnValuesArray[1] = parentbookingRowByFK_guest_booking[0];
                }
...
SELECT reference_num, name, address FROM customer WHERE (reference_num = @reference_num)";
    ...
    public partial class guestTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.DeleteCommand.Connection = this.Connection;
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[guest] WHERE (([id] = @Original_id) AND ([booking_ref] = @Orig" +
                "inal_booking_ref) AND ([passport_num] = @Original_passport_num) AND ([age] = @Or" +
                "iginal_age))";
            this._adapter.DeleteCommand.CommandType = global::System.Data.CommandType.Text;
            ...
            this._adapter.InsertCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[guest] ([id], [booking_ref], [passport_num], [age]) VALUES (@i" +
                "d, @booking_ref, @passport_num, @age);\r\nSELECT id, booking_ref, passport_num, ag" +
                "e FROM guest WHERE (id = @id)";
            this._adapter.InsertCommand.CommandType = global::System.Data.CommandType.Text;
            ...
            this._adapter.UpdateCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[guest] SET [id] = @id, [booking_ref] = @booking_ref, [passport_num] = @passport_num, [age] = @age WHERE (([id] = @Original_id) AND ([booking_ref] = @Original_booking_ref) AND ([passport_num] = @Original_passport_num) AND ([age] = @Original_age));
SELECT id, booking_ref, passport_num, age FROM guest WHERE (id = @id)";
            this._adapter.UpdateCommand.CommandType = global::System.Data.CommandType.Text;
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = "SELECT id, booking_ref, passport_num, age FROM dbo.guest";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
        }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Delete, true)]
        public virtual int Delete(int Original_id, int Original_booking_ref, string Original_passport_num, int Original_age) {
            this.Adapter.DeleteCommand.Parameters[0].Value = ((int)(Original_id));
            this.Adapter.DeleteCommand.Parameters[1].Value = ((int)(Original_booking_ref));
            if ((Original_passport_num == null)) {
                throw new global::System.ArgumentNullException("Original_passport_num");
            }
            else {
                this.Adapter.DeleteCommand.Parameters[2].Value = ((string)(Original_passport_num));
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Insert, true)]
        public virtual int Insert(int id, int booking_ref, string passport_num, int age) {
            this.Adapter.InsertCommand.Parameters[0].Value = ((int)(id));
            this.Adapter.InsertCommand.Parameters[1].Value = ((int)(booking_ref));
            if ((passport_num == null)) {
                throw new global::System.ArgumentNullException("passport_num");
            }
            else {
                this.Adapter.InsertCommand.Parameters[2].Value = ((string)(passport_num));
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(int id, int booking_ref, string passport_num, int age, int Original_id, int Original_booking_ref, string Original_passport_num, int Original_age) {
            this.Adapter.UpdateCommand.Parameters[0].Value = ((int)(id));
            this.Adapter.UpdateCommand.Parameters[1].Value = ((int)(booking_ref));
            if ((passport_num == null)) {
                throw new global::System.ArgumentNullException("passport_num");
            }
            else {
                this.Adapter.UpdateCommand.Parameters[2].Value = ((string)(passport_num));
            }
            this.Adapter.UpdateCommand.Parameters[3].Value = ((int)(age));
            this.Adapter.UpdateCommand.Parameters[4].Value = ((int)(Original_id));
            this.Adapter.UpdateCommand.Parameters[5].Value = ((int)(Original_booking_ref));
            if ((Original_passport_num == null)) {
                throw new global::System.ArgumentNullException("Original_passport_num");
            }
            else {
                this.Adapter.UpdateCommand.Parameters[6].Value = ((string)(Original_passport_num));
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(int booking_ref, string passport_num, int age, int Original_id, int Original_booking_ref, string Original_passport_num, int Original_age) {
            return this.Update(Original_id, booking_ref, passport_num, age, Original_id, Original_booking_ref, Original_passport_num, Original_age);
        }
    }
